...
namespace BoBo2D_Eyal_Gal
{
    public class Scene
    {
        ...
        public void Start()
        {
            ...
            GetSetGameObjects.Add(new GameObject("Empty Game Object", new Transform(new Vector3D(0, 0, 0), new Vector3D(1, 1, 1))));

            //testing hirarcy

            GetHirarchy.Add(new TreeOfGameObjects(new Node(new GameObject("Player"), null)));
            new Node(new GameObject("Player Hand", new Transform(new Vector3D(0, 0, 0), new Vector3D(1, 1, 1))), GetHirarchy[0].Root);
            BoxCollider bc = new BoxCollider(_gameObjects[0]);
            GetHirarchy[0].Root.GetChildren[0].GetGameObject.AddComponent(bc);
            GetHirarchy[0].Root.GetChildren[0].GetGameObject.AddComponent(new Transform(new Vector3D(0, 1, 0), new Vector3D(1, 1, 1)));
        ...
        public void AlternativeStart()
        {
            ...
            GameObject emptyGameObject = new GameObject("Empty Game Object", new Transform(new Vector3D(0, 0, 0), new Vector3D(1, 1, 1)));
            GameObject playerHand = new GameObject("Player Hand", new Transform(new Vector3D(0, 0, 0), new Vector3D(1, 1, 1)));
