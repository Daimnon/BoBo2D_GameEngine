...
{
    public class TextSprite2 : Component2, IDrawable
    {
        #region Fields
        ...
        #region Constructors
        public TextSprite2(GameObject2 gameObject, string fontName, Color color)
        {
        ...
        public TextSprite2(GameObject2 gameObject, string fontName)
        {
            GameObjectP = gameObject;
            TransformP = gameObject.GetComponent<Transform2>();
            Name = gameObject.Name;
